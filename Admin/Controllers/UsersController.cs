...
namespace Admin.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserTypeId,Name,Mail,Telefon,Password")] User user,HttpPostedFileBase Avatar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserTypeId,Name,Mail,Telefon,Password")] User user, HttpPostedFileBase Avatar)
        {
            if (ModelState.IsValid)
            {
