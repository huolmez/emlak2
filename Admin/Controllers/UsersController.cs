...
namespace Admin.Controllers
{
    public class UsersController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserTypeId,Name,Mail,Telefon,Password")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserTypeId,Name,Mail,Telefon,Password")] User user)
        {
            if (ModelState.IsValid)
            {
